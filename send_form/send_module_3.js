...
const checkSend  = async function(URL, getWebErr, cp = false) {
    ...
    /*
        ...
        4. Проверить работу скрипта без таймаутов +
            2.1 на локальном браузере
            2.2 на browser-stack
        5. Попробовать executeScript (при необходимости)
        6. Обработка сайтов с Клоакой (отслеживать по ссылкам на гугл, тильду)
